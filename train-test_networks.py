...
def run_experiment(
    ...
    savedir = f'results/saved_models/{experiment}-disease_labels={include_disease_labels}-val_split={val_split}-bootstraps={n_bootstraps}-dryrun={dry_run}'
